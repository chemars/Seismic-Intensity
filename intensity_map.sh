...
gawk 'BEGIN {FS=","}; {if ($7 == 0 || $7 == 1) print $3, $4, $7}' $data | gmt text -F+f$ts,$tt,black+jMC
gawk 'BEGIN {FS=","}; {if ($7 == 2) print $3, $4, $7}' $data | gmt text -F+f$ts,$tt,blue+jMC
gawk 'BEGIN {FS=","}; {if ($7 == 3 || $7 == 4) print $3, $4, $7}' $data | gmt text -F+f$ts,$tt,0/128/0+jMC
gawk 'BEGIN {FS=","}; {if (NR > 1 && $7 != 0 && $7 != 1 && $7 != 2 && $7 != 3 && $7 != 4) print $3, $4, $7}' $data | gmt text -F+f$ts,$tt,red+jMC
