...
gmt begin intensity_map_2000_$i png A+m1c
...
gawk 'BEGIN {FS=","}; {if ($5 == 2) print $3, $4, $5}' $data | gmt text -F+f$ts,,blue+jMC
gawk 'BEGIN {FS=","}; {if ($5 == 3 || $5 == 4) print $3, $4, $5}' $data | gmt text -F+f$ts,,0/128/0+jMC
gawk 'BEGIN {FS=","}; {if (NR > 1 && $5 >= 5) print $3, $4, $5}' $data | gmt text -F+f$ts,,red+jMC
